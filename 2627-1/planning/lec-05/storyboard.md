...
- A00 cho lượt $e_1$ trước công thức A01. A02 nêu đủ đầu vào, khởi tạo, vòng lượt, đầu ra, dừng và chi phí của MC lần ghé đầu tiên.
...
- A06 tách mọi lần ghé khỏi tuyến lõi. A07 chỉ phát biểu hội tụ chính cho lần ghé đầu tiên với các lượt khởi động lại độc lập.
...
- B06 định nghĩa $T^\pi$ rồi mới lấy kỳ vọng của $\delta_t$. B07 dùng $n$ là số lần cập nhật trạng thái, cho ví dụ $\alpha_n=1/n$ và diễn giải Robbins–Monro bằng “học mãi nhưng nhiễu giảm dần”.
- C00–C01 dùng đi bộ dài. C02 báo rõ trở lại lượt ngắn, chốt $\gamma=1$, $\alpha=0{,}5$ và bảng khởi tạo bằng không. C03 nối số nguồn ngẫu nhiên trong $G_t$ với biến động, rồi nối phần đuôi $V_t$ với chệch.
...
| A00 | Lượt cụ thể xuất hiện trước phần thưởng tích lũy. | Tính đích MC. |
| A01 | MC dùng toàn bộ phần còn lại sau lần ghé. | Viết thuật toán tái tạo được. |
| A02 | MC lần ghé đầu có đủ giao diện, vòng lặp, dừng và chi phí. | Chạy thuật toán trên hai lượt. |
...
| A06 | Mọi lần ghé cho $(1,1)$ sau $e_1$ và $(0,1/3)$ sau $e_2$ với trung bình mẫu. | Trở lại bảo đảm của tuyến chính. |
| A07 | Trung bình lần ghé đầu cần lượt độc lập, kỳ vọng hữu hạn và ghé vô hạn. | Kiểm tên thuật toán. |
| A08 | Tên “gia tăng” chưa xác định quy tắc mẫu và bước học. | Sang đích một bước. |
...
| B06 | Kỳ vọng sai số TD là sai số Bellman của $V_t$. | Chọn lịch bước học. |
| B07 | Robbins–Monro dùng số lần cập nhật của từng trạng thái; nhánh $\gamma=1$ cần lượt khởi động lại và chính sách đúng đắn. | Kiểm cập nhật tại chỗ. |
| B08 | Đích hàng hai dùng giá trị vừa cập nhật. | Sang quỹ đạo dài. |
| C00 | Quỹ đạo dài làm $G_t$ nhạy với đường đi. | Viết chỉ số. |
| C01 | Số mũ phụ thuộc vị trí phần thưởng. | Trở lại lượt ngắn để so phạm vi tác động. |
| C02 | Với cùng $\gamma,\alpha,V_0$, MC đổi S và x còn TD chỉ đổi x sau một lượt. | Giải thích chệch–phương sai. |
...
| X07 | Giải thích ba kết quả đã tính bằng mẫu, bước học và thời điểm cập nhật. | Chữa tổng hợp. |
