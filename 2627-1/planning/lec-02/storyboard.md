...
| Mô hình | D00 | D07 | D07 | D07 | D07 | D07 | chuyển tiếp mê cung tất định → mô hình chuẩn hóa | 6 phút |
...
| P02 | Tương tác, thông tin và quyết định tạo một chuỗi. | P01 | Có bản đồ bài. | “Bắt đầu bằng ranh giới hai phía.” |
...
| B04 | Giả thuyết phần thưởng chưa cần $\pi$ hay $G_t$. | B03 | Phát biểu không vượt tiên quyết. | “Dùng ba dấu hiệu để phân loại.” |
| B05 | Dữ liệu tuần tự chưa đủ để là RL. | B00–B04 | Phân loại tình huống. | “Dự báo phản hồi đòi hỏi trạng thái đủ.” |
...
| D00 | Chính sách, giá trị và mô hình trả lời ba câu khác nhau. | C07 | Có bản đồ vai trò; biết mô hình là tùy chọn. | “Định nghĩa chính sách trên $X_t$.” |
...
| D07 | Chuyển tiếp mê cung tất định có xác suất $1$ cho kết quả đúng, $0$ cho kết quả khác. | C03 và quy ước mê cung đã nêu ngay trên trang | Đi từ ví dụ $1/0$ tới mô hình rời rạc chuẩn hóa. | “Dự đoán và điều khiển dùng các vai trò khác nhau.” |
...
| E04 | Ảnh cục bộ có thể là quan sát một phần. | E03, C05 | Nêu bằng chứng và vai trò lịch sử. | “Khép lại vòng tương tác.” |
| E05 | Quan sát → biểu diễn → chính sách → phản hồi là trục bài. | Toàn bài | Biết Bài 03 đóng gói $\mathcal S,\mathcal A,p,\gamma$ thành MDP. | “Phân biệt ba mô hình trước Bellman.” |
| Z00 | Bài 03 đi từ chuỗi Markov tới quá trình phần thưởng Markov, MDP và Bellman. | E05 | Tự kiểm bốn đầu ra và biết tuyến bài kế tiếp. | “Nhấn xuống để chữa bài.” |
...
- Cụm D được tách thành bốn vi chu trình: chính sách; giá trị; mô hình; dự đoán và điều khiển. Không coi chín trang là một chu trình duy nhất.
