...
Sinh viên phân biệt dự đoán với điều khiển, theo chính sách với khác chính sách; tạo chính sách $\varepsilon$-tham lam từ bảng $Q$; thực hiện điều khiển MC lần ghé đầu tiên, SARSA và Q-learning dạng bảng; giải thích vai trò của đích cập nhật, thăm dò, GLIE, độ phủ và bước học Robbins–Monro.
...
| Điều khiển MC | B00–B06 | Phần thưởng tích lũy, thuật toán đầy đủ, hai bước học, cải thiện $\varepsilon$-mềm và GLIE |
...
Bộ trang chiếu có 34 trang chính và 3 trang bài tập dọc. Tuyến cốt lõi là 110 phút, không gồm D06–D07 hoặc E01–E02. D06–D07 là chủ đề bổ sung 12 trong 5 phút; E01–E02 là chủ đề bổ sung 14 trong 5 phút. Ba bài tập dọc dùng 30 phút theo phân bổ 5–10–15 phút.

## Danh mục mã trang

- Định hướng: P00, P01, P02, P03.
- Chính sách và ví dụ chung: A00, A01, A02, A03, A04.
- Điều khiển MC: B00, B01, B02, B03, B04, B05, B06.
...
| tr. 29 | E01–E02 | Sửa thành chặn Hoeffding điểm cho các phần thưởng tích lũy i.i.d. bị chặn; không suy sang điều khiển thích nghi |
...
- `shared-trace.svg`: lượt $D\to C\to B\to A$ và ba phần thưởng tích lũy.
