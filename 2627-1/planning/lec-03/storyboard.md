...
Bản viết lại dùng robot thu gom lon. Đã triển khai 5/7 phần; 38/50 slide. Phần chưa triển khai nằm trong [kế hoạch đầy đủ](storyboard-mdp-replanned.md). Bản HTML cũ đã được thay thế; không trộn các phần cũ vào deck mới.
