...
Bản viết lại dùng robot thu gom lon. Đã triển khai 6/7 phần; 46/50 slide. Phần chưa triển khai nằm trong [kế hoạch đầy đủ](storyboard-mdp-replanned.md). Bản HTML cũ đã được thay thế; không trộn các phần cũ vào deck mới.
