...
| Định lý và REINFORCE | `L09-28`–`L09-33` | 26 | 0 |
| Tổng | 33 trang chính | 110 | 10 |
...
| 39 | sửa, tách | `L09-28`–`L09-30` | Viết $\nabla J=\int G\nabla p=\mathbb E[G\nabla\log p]$; dùng kỳ vọng có điều kiện theo lịch sử; nối trọng số $\gamma^t$ với phân bố chiếm dụng. |
